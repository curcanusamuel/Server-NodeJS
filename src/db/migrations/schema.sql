...
\restrict JRVSwxf5lwWbqm4VqOl4ICgysDpADxbv3QiWK3PXmYpM6rgextzJZRd5PVhX5H7
...
--
-- Name: patients_approx_count(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: discounturi; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: istoricmedia; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.medical_letters (
    ...
    patient_name character varying(201) DEFAULT ''::character varying NOT NULL,
    patient_nid character varying(50) DEFAULT ''::character varying NOT NULL,
    doctor_id uuid NOT NULL,
    doctor_name character varying(200) DEFAULT ''::character varying NOT NULL,
    letter_date date NOT NULL,
    birth_date date,
    patient_age smallint,
    consult_type character varying(100),
    consultation_reason text,
    medical_history text,
    first_histo_cito text,
    first_histo_cito_date date,
    diagnosis text,
    staging character varying(50),
    staging_t character varying(20),
    staging_n character varying(20),
    staging_m character varying(20),
    stage character varying(20),
    icd_code character varying(20),
    icd_localization character varying(100),
    ecog smallint,
    exam_fields_json jsonb,
    objective_exam_notes text,
    clinical_imaging_biochemistry text,
    pain_intensity smallint,
    pain_localization text,
    analgesic_medication text,
    analgesic_adverse_effects text,
    dyspnea_intensity smallint,
    dyspnea_treatment text,
    interactions_checked boolean,
    treatment_goal text,
    therapeutic_conduct text,
    treatment_plan text,
    adverse_reactions_json jsonb,
    adverse_reactions_notes text,
    next_appointment_date date,
    periodic_control_interval character varying(100),
    periodic_control_notes text,
    lifestyle_recommendations text,
    other_recommended_investigations text,
    genetic_counseling text,
    other_recommendations text,
    icd_indication text,
    return_admission boolean,
    return_admission_days integer,
    prescription_status boolean,
    prescription_series character varying(20),
    prescription_number character varying(50),
    medical_leave_status boolean,
    medical_leave_series character varying(20),
    medical_leave_number character varying(50),
    home_care_recommendation text,
    medical_devices_prescription text,
    ...
    deleted_at timestamp with time zone,
    version integer DEFAULT 1 NOT NULL,
    CONSTRAINT medical_letters_dyspnea_intensity_check CHECK (((dyspnea_intensity IS NULL) OR ((dyspnea_intensity >= 0) AND (dyspnea_intensity <= 10)))),
    CONSTRAINT medical_letters_ecog_check CHECK (((ecog IS NULL) OR ((ecog >= 0) AND (ecog <= 5)))),
    CONSTRAINT medical_letters_pain_intensity_check CHECK (((pain_intensity IS NULL) OR ((pain_intensity >= 0) AND (pain_intensity <= 10)))),
    CONSTRAINT medical_letters_patient_age_check CHECK (((patient_age IS NULL) OR ((patient_age >= 0) AND (patient_age <= 150)))),
    CONSTRAINT medical_letters_return_admission_days_check CHECK (((return_admission_days IS NULL) OR (return_admission_days >= 0)))
);
...
--
-- Name: servicii; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: sub_categorie; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: istoricmedia istoricmedia_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: patients patients_cod_cnp_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: discounturi pk_discounturi; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: doctor pk_doctor; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: servicii pk_servicii; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sub_categorie pk_sub_categorie; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: doctor uq_doctor_user; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_istoricmedia_data_document; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_istoricmedia_name_trgm; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_istoricmedia_pacient; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_istoricmedia_pacient_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_medical_letters_created_by; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_created_by ON public.medical_letters USING btree (created_by_user_id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_date_range; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_date_range ON public.medical_letters USING btree (letter_date DESC, id) INCLUDE (validated, doctor_id, patient_id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_diagnosis_asc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_diagnosis_asc ON public.medical_letters USING btree (diagnosis, letter_date DESC, id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_diagnosis_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_diagnosis_desc ON public.medical_letters USING btree (diagnosis DESC, letter_date DESC, id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_doctor_asc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_doctor_asc ON public.medical_letters USING btree (doctor_id, letter_date DESC, id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_doctor_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_doctor_date ON public.medical_letters USING btree (doctor_id, letter_date DESC, id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_doctor_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_doctor_desc ON public.medical_letters USING btree (doctor_id DESC, letter_date DESC, id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_doctor_name_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_doctor_name_trgm ON public.medical_letters USING gin (doctor_name public.gin_trgm_ops) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_list_default; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_list_default ON public.medical_letters USING btree (letter_date DESC, id) INCLUDE (patient_id, patient_name, patient_nid, doctor_id, doctor_name, validated, validated_by_user_id, validated_at, diagnosis, updated_at, media_item_id, created_by_user_id, created_at) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_media_item; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_media_item ON public.medical_letters USING btree (media_item_id) WHERE (media_item_id IS NOT NULL);


--
-- Name: idx_medical_letters_patient_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_patient_date ON public.medical_letters USING btree (patient_id, letter_date DESC, id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_patient_name_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_patient_name_trgm ON public.medical_letters USING gin (patient_name public.gin_trgm_ops) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_patient_nid_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_patient_nid_trgm ON public.medical_letters USING gin (patient_nid public.gin_trgm_ops) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_unvalidated; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_unvalidated ON public.medical_letters USING btree (letter_date DESC, id) WHERE ((validated = false) AND (deleted_at IS NULL));


--
-- Name: idx_medical_letters_updated_asc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_updated_asc ON public.medical_letters USING btree (updated_at, id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_updated_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_updated_desc ON public.medical_letters USING btree (updated_at DESC, id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_validated_asc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_validated_asc ON public.medical_letters USING btree (validated, letter_date DESC, id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_validated_at_asc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_validated_at_asc ON public.medical_letters USING btree (validated_at, letter_date DESC, id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_validated_at_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_validated_at_desc ON public.medical_letters USING btree (validated_at DESC, letter_date DESC, id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_validated_by_asc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_validated_by_asc ON public.medical_letters USING btree (validated_by_user_id, letter_date DESC, id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_validated_by_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_validated_by_desc ON public.medical_letters USING btree (validated_by_user_id DESC, letter_date DESC, id) WHERE (deleted_at IS NULL);


--
-- Name: idx_medical_letters_validated_desc; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_medical_letters_validated_desc ON public.medical_letters USING btree (validated DESC, letter_date DESC, id) WHERE (deleted_at IS NULL);


--
-- Name: idx_patients_cod_cnp_trgm; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_email_asc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_email_desc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_is_verified_asc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_is_verified_desc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_list_default; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_localitate_asc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_localitate_desc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_localitate_trgm; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_medic_curant_asc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_medic_curant_desc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_medic_curant_trgm; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_medic_familie_asc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_medic_familie_desc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_medic_familie_trgm; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_nid_asc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_nid_desc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_nid_trgm; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_nume_asc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_nume_complet_trgm; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_nume_desc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_nume_trgm; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_prenume_trgm; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_sursa_informare_asc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_sursa_informare_desc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_varsta_asc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_patients_varsta_desc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_discounturi_doctor_pret; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_discounturi_overlap_baza; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_discounturi_overlap_doctor; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_discounturi_overlap_promotie; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_discounturi_pret_type_dates; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_servicii_cod_procedura; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_servicii_subcategorie; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ix_sub_categorie_module; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: app_user update_app_user_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: medical_letters update_medical_letters_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_medical_letters_updated_at BEFORE UPDATE ON public.medical_letters FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: discounturi fk_discounturi_doctor; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: discounturi fk_discounturi_servicii; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: medical_letters fk_medical_letters_created_by; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.medical_letters
    ADD CONSTRAINT fk_medical_letters_created_by FOREIGN KEY (created_by_user_id) REFERENCES public.app_user(id);


--
-- Name: medical_letters fk_medical_letters_doctor; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.medical_letters
    ADD CONSTRAINT fk_medical_letters_doctor FOREIGN KEY (doctor_id) REFERENCES public.doctor(zk_doctor_id_p);


--
-- Name: medical_letters fk_medical_letters_media_item; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.medical_letters
    ADD CONSTRAINT fk_medical_letters_media_item FOREIGN KEY (media_item_id) REFERENCES public.istoricmedia(zk_istoricmedia_p);


--
-- Name: medical_letters fk_medical_letters_patient; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.medical_letters
    ADD CONSTRAINT fk_medical_letters_patient FOREIGN KEY (patient_id) REFERENCES public.patients(id);


--
-- Name: medical_letters fk_medical_letters_validated_by; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.medical_letters
    ADD CONSTRAINT fk_medical_letters_validated_by FOREIGN KEY (validated_by_user_id) REFERENCES public.app_user(id);


--
-- Name: servicii fk_servicii_module; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sub_categorie fk_sub_categorie_module; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: servicii servicii_zk_idsubcategorie_f_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: discounturi; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.discounturi ENABLE ROW LEVEL SECURITY;

--
-- Name: doctor; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.doctor ENABLE ROW LEVEL SECURITY;

--
-- Name: istoricmedia; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.istoricmedia ENABLE ROW LEVEL SECURITY;

--
-- Name: medical_letters; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.medical_letters ENABLE ROW LEVEL SECURITY;

--
-- Name: module; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: servicii; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: sub_categorie; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.sub_categorie ENABLE ROW LEVEL SECURITY;
